...
const AppProvider = ({children}) => {
    ...
    //   }
      ...
      //   getAll();
      // },[]);
    return <AppContext.Provider value={ {storeList,setStoreList,productList,setProductList,userInfo,setUserInfo,loginStatus,setLoginStatus,cartProducts,setCartProducts}}>{children}</AppContext.Provider>  
}
