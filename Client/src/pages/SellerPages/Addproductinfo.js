...
const Addproductinfo = () => {
  ...
  //       ...variant,
  //       values : [...variant.values,variantValue]
  //     }
  //     const addingValue = {
  //       ...variant,
  //       values : [variantValue]
  ...
  //     setFormData((prev)=>({
  //       ...prev,
  //       variants: [...prev.variants, addingValue],
  //     }));
  //     setVariantValue({
  //       name:'',
  //       amount:'',
  ...
  //   setFormData({
  //     ...formData,
  //     variants: [...formData.variants, addingValue],
  //   });
  //   setVariant({
  //     type:'',
  //     values:[]
  ...
  const handleAddVariant = ()=>{
    ...
    const newVariant = {
      ...
      productAmount: { 
        weight: formData.productAmount.weight, 
        amount: formData.productAmount.amount 
      },
      isAvailable: true,
    ...
    setVariantArray(newVariant)
    if(variantArray.length > 0){
      setVariantArray([...variantArray,newVariant]);
    }
    else{
      setVariantArray([newVariant]);
    }
  ...
  const addProductVariant = async(productId) =>{
    try{
      ...
      const updatedArray = variantArray.map((variant)=>{
        return {
          ...variant,
          productId : productId,
      }})
      setVariantArray(updatedArray);
      const productPromises = updatedArray.map(async(variant)=>{
        const form = new FormData();
  ...
  return (
    <>
        ...
        clearImages={clearImages} setClearImages={setClearImages}/></div>
          ...
          variantArray.map((variant,ind)=>{
            return <div className='w-full h-full'>
              ...
              <div className='flex justify-between w-full'>
                <div className=''><div className='text-xl font-semibold '>Product variant</div></div>
                <div 
                onClick={()=>handleDeleteVariant(ind)}
