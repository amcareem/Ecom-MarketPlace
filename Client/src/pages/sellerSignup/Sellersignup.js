...
const Sellersignup = ({setSlideFull,slideFull}) => {
  ...
  const handleSubmit = async(e) =>{
    ...
    try{
      ...
      console.log(res1);
      const shopData = {
        id: res1.data.user._id,
        shopName: res1.data.user.shopName,
        shopType : res1.data.user.shopType,
        openingTime : res1.data.user.shopTimings.openingTime,
        closingTime : res1.data.user.shopTimings.closingTime
      }
